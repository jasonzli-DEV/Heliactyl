    ...
    <div className="p-6 lg:p-8 max-w-7xl mx-auto animate-fadeIn">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400">
          Purchase permanent resources and coins.
        ...
        <div className="mt-3 p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
          <p className="text-sm text-blue-400">
            💡 Buy <strong>Server Slots</strong>, <strong>Databases</strong>, <strong>Backups</strong>, and <strong>Ports</strong> here. These last forever! Server RAM/CPU/Disk are billed hourly while running.
          </p>
        </div>
      </div>
